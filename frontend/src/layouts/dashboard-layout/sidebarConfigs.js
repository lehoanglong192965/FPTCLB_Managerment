...
export const SIDEBAR_CONFIGS = {
  ...
  MEMBER: [
    ...
    { key: "club-register", label: "Đăng Ký Thành Lập CLB", icon: FileText,       path: "/member/club-register" },
    { key: "club-register-history", label: "Lịch Sử Đăng Ký CLB", icon: Clock,      path: "/member/club-register-history" },
