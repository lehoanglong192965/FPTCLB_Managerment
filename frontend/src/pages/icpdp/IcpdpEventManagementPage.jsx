...
import IcpdpEventApprovalPage from "./IcpdpEventApprovalPage";
import IcpdpReportReviewPage from "./IcpdpReportReviewPage";
...
export default function IcpdpEventManagementPage() {
  ...
  return (
    <div>
      ...
      {tab === "approval" && <IcpdpEventApprovalPage embedded />}
      {tab === "report" && <IcpdpReportReviewPage embedded />}

      {tab === "list" && (<>

      {/* Filters — đồng bộ với các trang danh sách khác (ClubEventsManagementPage, IcpdpEventApprovalPage,
          IcpdpClubManagementPage): ô tìm kiếm riêng 1 hàng, bên dưới là tab gạch chân có số đếm,
