...
import RecruitmentCycleManagementPage from "./RecruitmentCycleManagementPage";
...
export default function ClubApplicationsManagementPage() {
  ...
  return (
    <div>
      ...
      {tab === "recruitment" && <RecruitmentCycleManagementPage embedded />}
