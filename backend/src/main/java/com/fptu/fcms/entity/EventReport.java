...
public class EventReport {
    ...
    private String reportSource = "MANUAL_UPLOAD";

    @Column(name = "autoGeneratedAt")
    private LocalDateTime autoGeneratedAt;

    @Column(name = "generatorVersion", length = 20)
    private String generatorVersion;

    @Column(name = "templateVersion", length = 20)
    private String templateVersion;

    @Column(name = "reportDataHash", length = 64)
    private String reportDataHash;

    @Column(name = "reportSnapshotJson", columnDefinition = "NVARCHAR(MAX)")
    private String reportSnapshotJson;

    @Column(name = "leaderCommentsJson", columnDefinition = "NVARCHAR(MAX)")
    private String leaderCommentsJson;

    @Column(name = "pdfHash", length = 64)
